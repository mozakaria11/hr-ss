...
public final class MainActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle state) {
        ...
        setContentView(root);
        applyAndroid15SystemBarInsets(root);
        configureWebView();
        if (state == null) webView.loadUrl(APP_URL); else webView.restoreState(state);
    }

    private void applyAndroid15SystemBarInsets(FrameLayout root) {
    ...
    private void configureWebView() {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " SawaedEmployee/1.12 AndroidWebView");
