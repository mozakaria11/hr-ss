...
ارفع محتويات هذا المجلد إلى جذر مستودع GitHub. يشغّل الملف `.github/workflows/build-apk.yml` بناء APK تلقائيًا، ثم يضع الملف الناتج في **Actions > Artifacts** باسم `Sawaed-Employee-APK-1.11.0`. توجد خطوات عربية مفصلة في `GITHUB_UPLOAD_GUIDE_AR.md`.
